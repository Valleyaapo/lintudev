    ...
    return (
        <section className="min-h-[90vh] flex items-center border-b border-border relative overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
                <div className="hero-blob hero-blob--primary absolute top-0 right-0 w-[40vh] h-[40vh] md:w-[60vh] md:h-[60vh] bg-primary rounded-full blur-[120px] md:blur-[150px] translate-x-1/3 -translate-y-1/4 opacity-20"></div>
                <div className="hero-blob hero-blob--accent absolute bottom-0 left-0 w-[36vh] h-[36vh] md:w-[50vh] md:h-[50vh] bg-accent rounded-full blur-[90px] md:blur-[120px] -translate-x-1/4 translate-y-1/3 opacity-15"></div>
            </div>
